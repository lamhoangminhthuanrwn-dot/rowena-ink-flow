...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Xác nhận email — ROWENA Tattoo',
  invite: 'Bạn được mời tham gia ROWENA Tattoo',
  magiclink: 'Link đăng nhập — ROWENA Tattoo',
  recovery: 'Đặt lại mật khẩu — ROWENA Tattoo',
  email_change: 'Xác nhận thay đổi email — ROWENA Tattoo',
  reauthentication: 'Mã xác minh — ROWENA Tattoo',
}
...
const SENDER_DOMAIN = "notify.lamthuan.codes"
const ROOT_DOMAIN = "lamthuan.codes"
const FROM_DOMAIN = "lamthuan.codes" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://a3e76723-1da8-4574-9a2d-94de180aa8ff.lovableproject.com"
