...
### Tổng quan
Dựa trên file CSV, mỗi mẫu xăm chính có nhiều **nhánh giá** phân theo: vị trí (trắng đen / màu), thể loại (đá nét, đá tổ, đâu, nhạt, linework), và mức giá theo độ khó (đơn giản, trả hết, trong ngày, hình khó).
...
└── variants?: TattooVariant[]
    ...
    ├── style: string       ("Đá nét" | "Đá tổ" | "Đâu" | "Nhạt" | "Linework")
